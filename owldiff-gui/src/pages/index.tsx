...
const IndexPage = () => {
    ...
    return (
        <Layout pageTitle="OWLDiff">
            <Toolkit comparisonSettings={comparisonSettings} setComparisonSettings={setComparisonSettings}
                     onMerge={onMerge} disabled={loading || resultComparison == null}/>
            ...
            <div className={styles.buttons_div}>
                <Box sx={{display: 'flex', flexFlow: 'column', justifyContent: 'center', alignItems: 'center'}}>
                    <UploadButton setParentUploadedFile={setOriginalOntology} parentUploadedFile={originalOntology}
                                  text="Upload original ontology"/>
                    {resultComparison == null &&
                        <FormHelperText>Ontology must be a file type of<br/> .owl, .obo, .ttl, .owx, .omn,
                            .ofn</FormHelperText>}
                </Box>
                <Box sx={{display: 'flex', flexFlow: 'column', justifyContent: 'center', alignItems: 'center'}}>
                    <UploadButton setParentUploadedFile={setUpdateOntology} parentUploadedFile={updateOntology}
                                  text="Upload updated ontology"/>
                    {resultComparison == null &&
                        <FormHelperText>Ontology must be a file type of<br/> .owl, .obo, .ttl, .owx, .omn,
                            .ofn</FormHelperText>}
                </Box>
                <Button sx={{minWidth: 'inherit', height: '36.5px'}} variant="contained" component="span"
                        startIcon={<ClearIcon/>} onClick={clearOntologies}>
                    Clear
                </Button>
            </div>
                    ...
                    <div className={stylesComponents.paper_flex}>
                        {resultComparison != null &&
                            <>
                                ...
                                <Paper sx={{width: '45%', wordWrap: "break-word", marginLeft: 2, minWidth: '300px'}}
                                       elevation={24}>
