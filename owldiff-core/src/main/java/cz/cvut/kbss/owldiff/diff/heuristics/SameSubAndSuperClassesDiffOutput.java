...
public class SameSubAndSuperClassesDiffOutput implements OWLDiffOutput {

    private Map<OWLClass, OWLClass> possiblyRenamed;
    private Set<OWLChange> changes;

    public SameSubAndSuperClassesDiffOutput() {
    ...
    public String outputToString() {
        String out = "\nOWLDiff - Heuristic Diff - Possibly renamed classes\n\n";
