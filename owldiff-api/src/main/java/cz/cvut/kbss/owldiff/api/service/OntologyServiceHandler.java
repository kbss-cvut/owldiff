...
import cz.cvut.kbss.owldiff.api.util.OntologyManager;
...
public class OntologyServiceHandler {
    ...
    public OntologyServiceHandler() {
        ...
        originalOntologyManager = new OntologyManager();
        updateOntologyManager = new OntologyManager();
    }
    ...
    public String getComparisonBySession(ComparisonDto comparisonDto) throws JsonProcessingException {
        ObjectMapper mapper = new ObjectMapper();
        mapper.setVisibility(PropertyAccessor.FIELD, JsonAutoDetect.Visibility.ANY);
        return mapper.writeValueAsString(comparisonDto);
    }
